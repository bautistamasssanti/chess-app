package src.chessGames.commons.gameMode.WinConditions;

import src.chessGames.chess.gameState.ChessGameStateFactory;
import src.chessGames.commons.GameStateFactory;
import src.chessGames.commons.gameMode.gameRules.IsPlayerNotInCheck;
...
public class HasAttackerCheckmatedOpponent implements WinCondition {
    ...
    public HasAttackerCheckmatedOpponent(GameStateFactory gameStateFactory) {
