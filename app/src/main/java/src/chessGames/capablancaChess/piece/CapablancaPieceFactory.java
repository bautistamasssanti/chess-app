package src.chessGames.capablancaChess.piece;

import src.chessGames.capablancaChess.moveRules.CapablancaMoveRulesFactoy;
...
public class CapablancaPieceFactory implements PieceFactory {
