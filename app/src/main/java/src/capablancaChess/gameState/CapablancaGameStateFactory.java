package src.capablancaChess.gameState;
...
public class CapablancaGameStateFactory {
    private final CapablancaPieceFactory pieceFactory = new CapablancaPieceFactory();
